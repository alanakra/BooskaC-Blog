...
$billet = $billetRepo->findOneBy(array('id'=>$_GET['id']));
$commentaireRepo = $entityManager->getRepository('Commentaire');
$afficheCommentaire = $commentaireRepo->findAll();
// $afficheCommentaire = $commentaireRepo -> findBy(array(),array('id'=>'DESC'),3);

?>
<title>Booska-C | <?php echo $billet->getIntitule() ?></title>
<body>
<nav class="navbar navbar-expand-lg bg-dark">
 <a href="affichebillets.php" class="navbar-brand text-light">Booska-C</a>
 ...
 <div class="container">
   ...
   <div class=col-12>
    ...
    <div class="card mt-2 mb-2">
      ...
      <div class="card-body">
        <h5 class="card-title"><?php echo $commentaire->getDatepost()->format('d-m-Y') ?></h5>
